...
module.exports.parseHTML = function parseHTML(html) {
  ...
  const imgParent = stack[0].children[1].children[3].children[1];
  const img0 = imgParent.children[1];
  const img1 = imgParent.children[3];
  // <img id="myid" class="my-img" />  -> width: 100px
  // <img /> -> width: 30px
  // <img id="myid" />  -> width: 80px
  console.log(img0); 
  console.log(img1);  
  debugger; // @助教Zola
}
