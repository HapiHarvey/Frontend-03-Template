  ...
  render() {
    ...
    let children = this.data.map((url, currentPosition) => {
      ...
      let onPanend = event => {
        ...
        let currentAnimation = new Animation(currentElement.style, 'transform', 500, 500, 0, ease, v => `transformlateX(${v}px)`)
        let nextAnimation = new Animation(nextElement.style, 'tranform', 500 - 500 * nextPosition + offset + dx, 500 - 500 * nextPosition + direction * 500, 500, 0, ease, v => `translateX(${v}px)`)
    ...
    let nextPic = () => {
      ...
      // TODO:
      let currentAnimation = new Animatiion(current.style, 'transform', - 100 * position, - 100 - 100 * position, 500, 0, ease, v => `translateX(${5 * v}px)`)
